...
Public Class cGaji_Par_Tunj_TKD

    Private Sub tbl_Keluar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbl_Keluar.Click
        Me.Close()
    End Sub

    Private Sub cGaji_Par_Tunj_TKD_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        tampil_tabel()
    End Sub
    Sub tampil_tabel()
        ...
        Dim sql_Text_Comman As String = "SELECT " _
                                        ...
                                        & " Tunjangan_KD AS [Tunjangan Kemahalan Daerah] " _
                                        & " FROM cGaji_Par_Tunj_TKD " & mmkondisi _
    ...
    Private Sub TblCari01_Click(sender As Object, e As EventArgs) Handles TblCari01.Click
        view_bPar_Gol_Pangkat.mKodePanggil.Text = "cGaji_Par_Tunj_TKD"
        view_bPar_Gol_Pangkat.ShowDialog(Me)

        mTunjangan_KD.Text = ""

        If Open_eSumsel() = False Then Exit Sub
        Rs_Baca.Open("Select * from cGaji_Par_Tunj_TKD where " _
                     & " Tahun = '" & mTahun.Text.Trim & "' and " _
                     & " Gol = '" & mGol.Text.Trim & "'", cn_eSumsel)

        If Rs_Baca.RecordCount > 0 Then
            Rs_Baca.MoveFirst()
            mTunjangan_KD.Text = Format(Rs_Baca.Fields("Tunjangan_KD").Value, "###,###.00")
        End If
        Rs_Baca.Close()
        Close_eSumsel()
        tampil_tabel()
    ...
    Private Sub dg_TampilData_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dg_TampilData.CellDoubleClick
        ...
        mTunjangan_KD.Text = Format(dg_TampilData.Item(3, dg_TampilData.CurrentRow.Index).Value, "###,###.00")
    ...
    Private Sub tblSimpan_Click(sender As Object, e As EventArgs) Handles tblSimpan.Click
        ...
        If Val(mTunjangan_KD.Text) <= 0 Then
        ...
        Rs_Simpan.Open("Select Tahun from cGaji_Par_Tunj_TKD where " _
                       & " Tahun='" & mTahun.Text & "' and " _
                       & " Gol = '" & mGol.Text & "'  ", cn_eSumsel)
        ...
        Dim DeKlare_Data As String = " set dateformat DMY " _
                       ...
                       & " " _
                        ...
                        & " Set @Tunjangan_KD= '" & mTunjangan_KD.Text & "' " _
        ...
        Dim Insert_Data As String = " " _
                   & "INSERT INTO cGaji_Par_Tunj_TKD" _
                   & "(Tahun,Gol,Pangkat,Tunjangan_KD,UserID_Entry,komputer,MAC0,MAC1,IPAdress,MBId,ProcId,Tanggal,Kode_Dokumen) values " _
                   & "(@Tahun,@Gol,@Pangkat,@Tunjangan_KD,@UserID_Entry,@komputer,@MAC0,@MAC1,@IPAdress,@MBId,@ProcId,@Tanggal,@Kode_Dokumen)"

        Dim Update_Data As String = " " _
            & " Update cGaji_Par_Tunj_TKD Set" _
            & " Tahun = @Tahun, " _
            & " Gol= @Gol," _
            & " Pangkat= @Pangkat," _
            & " Tunjangan_KD= @Tunjangan_KD, " _
    ...
    Private Sub tblHapus_Click(sender As Object, e As EventArgs) Handles tblHapus.Click
        ...
        If Pesan = MsgBoxResult.Yes Then
            If Open_eSumsel() = False Then Exit Sub
            Rs_Simpan.Open("Delete from cGaji_Par_Tunj_TKD where " _
                           & " Tahun = '" & mTahun.Text & "' and " _
                           & " Gol = '" & mGol.Text & "' ", cn_eSumsel)
    ...
    Private Sub mTunjangan_KD_GotFocus(sender As Object, e As EventArgs) Handles mTunjangan_KD.GotFocus
        mTunjangan_KD.Text = Format(ValChip(mTunjangan_KD.Text), "######.##")
    End Sub

    Private Sub mTunjangan_KD_LostFocus(sender As Object, e As EventArgs) Handles mTunjangan_KD.LostFocus
        mTunjangan_KD.Text = Format(ValChip(mTunjangan_KD.Text), "###,###.00")
    End Sub
