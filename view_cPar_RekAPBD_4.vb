...
Public Class view_cPar_RekAPBD_4
    ...
    Sub Tampil_Data()
        ...
        If mCari.Text.Trim = "" Then
            ...
            End If
        Else
            sql_Kondisi = " where Nama_Rek_Objek like '%" & mCari.Text.Trim & "%' " & sql_kondisi_rek.Trim
        End If
        ...
        Dim sql_Perintah As String = " SELECT       " _
                        ...
                        & " Rek_Kelompok & '.' &   " _
                        & " Rek_Jenis &  '.' &  " _
                        & " Rek_Objek   as [Kd Rekening],  " _
                        & " Nama_Rek_Objek as [Rekening Rincian Objek], " _
                        & " Rek_Pos,  " _
                        & " Rek_Kelompok,  " _
                        & " Rek_Jenis,  " _
                        & " Rek_Objek   " _
                        & " FROM         cPar_RekAPBD_4 " & sql_Kondisi _
                        & " ORDER BY  " _
                        & " Rek_Pos,  " _
                        & " Rek_Kelompok,  " _
                        & " Rek_Jenis,  " _
    ...
    Private Sub view_cPar_RekAPBD_4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
