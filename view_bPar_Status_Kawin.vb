...
Public Class view_bPar_Status_Kawin
    Private Sub tbl_Keluar_Click(sender As Object, e As EventArgs) Handles tbl_Keluar.Click
        Me.Close()
    End Sub

    Private Sub view_bPar_Status_Kawin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
    ...
    Sub Tampil_Data()
        ...
        Dim sql_Perintah As String = " SELECT       " _
                & " Kode_Status_Kawin AS Kode,  " _
                & " Staus_Kawin AS [Status Kawin] " _
                & " FROM         bPar_Status_Kawin " _
                & " ORDER BY No_Urut "
