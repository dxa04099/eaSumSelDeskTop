...
Public Class view_cPar_RekAkrual_2
    ...
    Sub Tampil_Data()
        ...
        Dim sql_Perintah As String = " SELECT       " _
                        & " " _
                        & " akr_Rek_Pos  & '.' &   " _
                        & " akr_Rek_Kelompok  as [Kd Rekening],  " _
                        & " akr_Nama_Rek_Kelompok as [Rekening Kelompok], " _
                        & " akr_Rek_Pos,  " _
                        & " akr_Rek_Kelompok " _
    ...
    Private Sub tblGunakan_Click(sender As Object, e As EventArgs) Handles tblGunakan.Click
        ...
        If mKodePanggil.Text.Trim = "cPar_RekAkrual_3" Then
            cPar_RekAkrual_3.mRek_Pos.Text = dg_TampilData.Item(2, dg_TampilData.CurrentRow.Index).Value
            cPar_RekAkrual_3.mRek_Kelompok.Text = dg_TampilData.Item(3, dg_TampilData.CurrentRow.Index).Value
            cPar_RekAkrual_3.mNama_Rek_Kelompok.Text = dg_TampilData.Item(1, dg_TampilData.CurrentRow.Index).Value
        End If
    ...
    Private Sub view_cPar_RekAkrual_2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
