...
Public Class view_bPar_Jurnal
    Private Sub tbl_Keluar_Click(sender As Object, e As EventArgs) Handles tbl_Keluar.Click
        Me.Close()
    End Sub

    Private Sub view_bPar_Jurnal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
    ...
    Sub Tampil_Data()
        ...
        Dim sql_Perintah As String = " SELECT       " _
                & " Kode_Jurnal AS Kode,  " _
                & " Nama_Jurnal AS [Nama Juranal] " _
                & " FROM         bPar_Jurnal " _
                & " ORDER BY Kode_Jurnal "
