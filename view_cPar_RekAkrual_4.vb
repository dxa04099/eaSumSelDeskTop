...
Public Class view_cPar_RekAkrual_4
    ...
    Sub Tampil_Data()
        ...
        If mCari.Text.Trim = "" Then
            ...
            End If
        Else
            sql_Kondisi = " where akr_Nama_Rek_Objek like '%" & mCari.Text.Trim & "%' " & sql_kondisi_rek.Trim
        End If
        ...
        Dim sql_Perintah As String = " SELECT       " _
                        ...
                        & " akr_Rek_Kelompok & '.' &   " _
                        & " akr_Rek_Jenis &  '.' &  " _
                        & " akr_Rek_Objek   as [Kd Rekening],  " _
                        & " akr_Nama_Rek_Objek as [Rekening Rincian Objek], " _
                        & " akr_Rek_Pos,  " _
                        & " akr_Rek_Kelompok,  " _
                        & " akr_Rek_Jenis,  " _
                        & " akr_Rek_Objek   " _
                        & " FROM         cPar_RekAkrual_4 " & sql_Kondisi _
                        & " ORDER BY  " _
                        & " akr_Rek_Pos,  " _
                        & " akr_Rek_Kelompok,  " _
                        & " akr_Rek_Jenis,  " _
    ...
    Private Sub view_cPar_RekAkrual_4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
