...
Public Class view_bPerjadin_Par_Kelompok
    Private Sub tbl_Keluar_Click(sender As Object, e As EventArgs) Handles tbl_Keluar.Click
        Me.Close()
    End Sub

    Private Sub view_bPerjadin_Par_Kelompok_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
    ...
    Sub Tampil_Data()
        ...
        Else
            sql_Kondisi = " where Kode_Kelompok like '%" & mCari.Text.Trim & "%' or Kelompok like '%" & mCari.Text.Trim & "%' "
        End If

        Dim sql_Perintah As String = " SELECT       " _
                & " Kode_Kelompok AS Kode,  " _
                & " Kelompok,  " _
                & " PNS_NON AS [PNS/Non PNS] " _
                & " FROM         bPerjadin_Par_Kelompok " & sql_Kondisi _
