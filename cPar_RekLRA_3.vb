...
Public Class cPar_RekLRA_3
    ...
    Sub tampil_REK_Jenis()
        ...
        Dim sql_Text_Comman As String = " SELECT Rek_LRA_Pos + '.' + Rek_LRA_Kelompok + '.' + Rek_LRA_Jenis AS [Rekening] " _
                                        & "  ,Nama_Rek_LRA_Jenis AS [Nama Rekening] " _
                                        & "  ,Rek_LRA_Pos" _
                                        & "  ,Rek_LRA_Kelompok" _
                                        & "  ,Rek_LRA_Jenis" _
                                        & " FROM cPar_RekLRA_3 " & sql_Kondisi _
                                        & " ORDER By Rek_LRA_Pos,Rek_LRA_Kelompok,Rek_LRA_Jenis "
    ...
    Private Sub tbCari01_Click(sender As Object, e As EventArgs) Handles tbCari01.Click
        ...
        'view_cPar_RekLRA_1.mKodePanggil.Text = "cPar_RekLRA_3"
        'view_cPar_RekLRA_1.ShowDialog(Me)
        'view_cPar_RekLRA_2.mRek_LRA_Pos.Text = mRek_LRA_Pos.Text.Trim
        view_cPar_RekLRA_2.mKodePanggil.Text = "cPar_RekLRA_3"
        view_cPar_RekLRA_2.ShowDialog(Me)
        tampil_REK_Jenis()
    End Sub
    Private Sub cPar_RekLRA_3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        tampil_REK_Jenis()
    End Sub
    ...
    Private Sub dg_TampilData_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dg_TampilData.CellDoubleClick
        ...
        nama_Rek_LRA_Kelompok()
        mRek_LRA_Jenis.Text = dg_TampilData.Item(4, dg_TampilData.CurrentRow.Index).Value.ToString.Trim
        mNama_Rek_LRA_Jenis.Text = dg_TampilData.Item(1, dg_TampilData.CurrentRow.Index).Value.ToString.Trim
    End Sub
    ...
    Private Sub tblSimpan_Click(sender As Object, e As EventArgs) Handles tblSimpan.Click
        ...
        Rs_Simpan.Open("Select Rek_LRA_Jenis from cPar_RekLRA_3  where " _
                       & " Rek_LRA_Kelompok = '" & mRek_LRA_Kelompok.Text.Trim & "'  AND " _
                       & " Rek_LRA_Pos = '" & mRek_LRA_Pos.Text.Trim & "'  AND " _
                       & " Rek_LRA_Jenis = '" & mRek_LRA_Jenis.Text.Trim & "' ", cn_eSumsel)
        ...
        Dim DeKlare_Data As String = " set dateformat DMY " _
                                   ...
                                   & "Declare @Nama_Rek_LRA_Jenis char(100) " _
                                   ...
                                   & " Set @Nama_Rek_LRA_Jenis = '" & mNama_Rek_LRA_Jenis.Text.Trim & "' " _
        ...
        Dim Insert_Data As String = " INSERT INTO cPar_RekLRA_3 " _
                                    & " (Rek_LRA_Pos,Rek_LRA_Kelompok,Rek_LRA_Jenis,Nama_Rek_LRA_Jenis,MAC0,MAC1,IPAdress,MBId,ProcId,Tanggal,komputer) VALUES " _
                                    & " (@Rek_LRA_Pos,@Rek_LRA_Kelompok,@Rek_LRA_Jenis,@Nama_Rek_LRA_Jenis, @MAC0, @MAC1, @IPAdress, @MBId, @ProcId, @Tanggal, @komputer) "

        Dim Update_Data As String = "UPDATE cPar_RekLRA_3 " _
                                    & " SET Rek_LRA_Pos = @Rek_LRA_Pos, " _
                                    & " Rek_LRA_Kelompok = @Rek_LRA_Kelompok, " _
                                    & " Rek_LRA_Jenis = @Rek_LRA_Jenis, " _
                                    & " Nama_Rek_LRA_Jenis = @Nama_Rek_LRA_Jenis, " _
                                    & " MAC0 = @MAC0, " _
                                    & " MAC1 = @MAC1, " _
                                    & " IPAdress = @IPAdress, " _
                                    & " MBId = @MBId, " _
                                    ...
                                    & " Tanggal = @Tanggal, " _
                                    & " komputer = @komputer " _
                                    & " WHERE Rek_LRA_Pos = '" & mRek_LRA_Pos.Text.Trim & "'  AND " _
                                    & " Rek_LRA_Kelompok = '" & mRek_LRA_Kelompok.Text.Trim & "'  AND " _
                                    & " Rek_LRA_Pos = '" & mRek_LRA_Pos.Text.Trim & "'  AND " _
                                    & " Rek_LRA_Jenis = '" & mRek_LRA_Jenis.Text.Trim & "' "
    ...
    Private Sub tblHapus_Click(sender As Object, e As EventArgs) Handles tblHapus.Click
        ...
        Dim Pesan = MsgBox("Yakin Rekening LRA Jenis " & mNama_Rek_LRA_Jenis.Text.Trim & " ini akan di Hapus [Y/T] ?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "Informasi")
        If Pesan = MsgBoxResult.Yes Then
            If Open_eSumsel() = False Then Exit Sub
            Rs_Simpan.Open("Delete from cPar_RekLRA_3  where " _
                           & " Rek_LRA_Pos = '" & mRek_LRA_Pos.Text.Trim & "' AND " _
                           & " Rek_LRA_Kelompok = '" & mRek_LRA_Kelompok.Text.Trim & "' AND   " _
                           & " Rek_LRA_Jenis = '" & mRek_LRA_Jenis.Text.Trim & "' ", cn_eSumsel)
            Close_eSumsel()
            ...
            tampil_REK_Jenis()
            tblBaru_Click(tblBaru, New EventArgs)
            MsgBox("Rekening LRA Jenis " & mNama_Rek_LRA_Jenis.Text.Trim & " telah dihapus.....", MsgBoxStyle.OkOnly + MsgBoxStyle.Information, "Informasi")
        End If


    End Sub

    Private Sub mRek_LRA_Jenis_LostFocus(sender As Object, e As EventArgs) Handles mRek_LRA_Jenis.LostFocus
        If mRek_LRA_Jenis.Text.Length = 0 Then Exit Sub
        If Open_eSumsel() = False Then Exit Sub
        Dim sql_Text_Comman As String = "SELECT " _
