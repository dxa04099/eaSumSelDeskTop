...
Public Class view_bPar_Indikator
    Private Sub tbl_Keluar_Click(sender As Object, e As EventArgs) Handles tbl_Keluar.Click
        Me.Close()
    End Sub

    Private Sub view_bPar_Indikator_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
    ...
    Sub Tampil_Data()
        ...
        Dim sql_Perintah As String = " SELECT       " _
            & " Kode_Indikator AS Kode,  " _
            & " Uraian_Indikator AS Indikator " _
            & " FROM         bPar_Indikator " _
