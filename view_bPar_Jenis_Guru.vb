...
Public Class view_bPar_Jenis_Guru
    Private Sub tbl_Keluar_Click(sender As Object, e As EventArgs) Handles tbl_Keluar.Click
        Me.Close()
    End Sub

    Private Sub view_bPar_Jenis_Guru_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
    ...
    Sub Tampil_Data()
        ...
        Else
            sql_Kondisi = " where Kode_GURU like '%" & mCari.Text.Trim & "%' or Jensi_Guru like '%" & mCari.Text.Trim & "%' "
        End If

        Dim sql_Perintah As String = " SELECT       " _
                    & " Kode_GURU AS Kode,  " _
                    & " Jensi_Guru AS [Jenis Guru] " _
                    & " FROM         bPar_Jenis_Guru " & sql_Kondisi _
                    & " ORDER BY Kode_GURU "
