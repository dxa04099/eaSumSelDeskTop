...
Public Class view_cPar_RekLRA_2
    ...
    Sub Tampil_Data()
        ...
        Dim sql_Perintah As String = " SELECT       " _
                        & " " _
                        & " Rek_LRA_Pos  & '.' &   " _
                        & " Rek_LRA_Kelompok   as [Kd Rekening],  " _
    ...
    Private Sub tblGunakan_Click(sender As Object, e As EventArgs) Handles tblGunakan.Click
        ...
        If mKodePanggil.Text.Trim = "cPar_RekLRA_3" Then
            cPar_RekLRA_3.mRek_LRA_Pos.Text = dg_TampilData.Item(2, dg_TampilData.CurrentRow.Index).Value
            cPar_RekLRA_3.mRek_LRA_Kelompok.Text = dg_TampilData.Item(3, dg_TampilData.CurrentRow.Index).Value
            cPar_RekLRA_3.mNama_Rek_LRA_Kelompok.Text = dg_TampilData.Item(1, dg_TampilData.CurrentRow.Index).Value
        End If
    ...
    Private Sub view_cPar_RekLRA_2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
