...
Public Class view_cPar_RekAPBD_2
    ...
    Sub Tampil_Data()
        ...
        If mCari.Text.Trim = "" Then
            ...
            End If
        Else
            sql_Kondisi = " where Nama_Rek_Kelompok like '%" & mCari.Text.Trim & "%' " & sql_kondisi_rek.Trim
        End If

        Dim sql_Perintah As String = " SELECT       " _
                        & " " _
                        & " Rek_Pos  & '.' &   " _
                        & " Rek_Kelompok  as [Kd Rekening],  " _
                        & " Nama_Rek_Kelompok as [Rekening Kelompok], " _
                        & " Rek_Pos,  " _
                        & " Rek_Kelompok " _
                        & " FROM         cPar_RekAPBD_2 " & sql_Kondisi _
                        & " ORDER BY  " _
                        & " Rek_Pos,  " _
                        & " Rek_Kelompok "
    ...
    Private Sub view_cPar_RekAPBD_2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
