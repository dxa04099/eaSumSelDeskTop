...
Public Class view_bGaji_Par_Jenis_Gaji
    Private Sub tbl_Keluar_Click(sender As Object, e As EventArgs) Handles tbl_Keluar.Click
        Me.Close()
    End Sub

    Private Sub view_bGaji_Par_Jenis_Gaji_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
    ...
    Sub Tampil_Data()
        ...
        Dim sql_Perintah As String = " SELECT       " _
            & " Kode_Jenis_Gaji as [kode],  " _
            & " Jenis_Gaji as [Jenis Gaji] " _
            & " FROM      bGaji_Par_Jenis_Gaji  " _
            & " ORDER BY Kode_Jenis_Gaji "
