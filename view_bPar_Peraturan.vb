...
Public Class view_bPar_Peraturan
    Private Sub tbl_Keluar_Click(sender As Object, e As EventArgs) Handles tbl_Keluar.Click
        Me.Close()
    End Sub

    Private Sub view_bPar_Peraturan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
    ...
    Sub Tampil_Data()
        ...
        Else
            sql_Kondisi = " where Kode_Peraturan like '%" & mCari.Text.Trim & "%' or Nama_Peraturan like '%" & mCari.Text.Trim & "%' "
        End If

        Dim sql_Perintah As String = " SELECT       " _
                    & " Kode_Peraturan AS Kode,  " _
                    & " Nama_Peraturan AS [Nama Peraturan] " _
                    & " FROM         bPar_Peraturan " & sql_Kondisi _
                    & " ORDER BY Kode_Peraturan "
