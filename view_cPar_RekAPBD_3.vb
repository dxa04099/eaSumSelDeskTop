...
Public Class view_cPar_RekAPBD_3
    ...
    Sub Tampil_Data()
        ...
        If mCari.Text.Trim = "" Then
            ...
            End If
        Else
            sql_Kondisi = " where Nama_Rek_Jenis like '%" & mCari.Text.Trim & "%' " & sql_kondisi_rek.Trim
        End If
        ...
        Dim sql_Perintah As String = " SELECT       " _
                        ...
                        & " Rek_Pos  & '.' &   " _
                        & " Rek_Kelompok & '.' &   " _
                        & " Rek_Jenis   as [Kd Rekening],  " _
                        & " Nama_Rek_Jenis as [Rekening Jenis], " _
                        & " Rek_Pos,  " _
                        & " Rek_Kelompok,  " _
                        & " Rek_Jenis   " _
                        & " FROM         cPar_RekAPBD_3 " & sql_Kondisi _
                        & " ORDER BY  " _
                        & " Rek_Pos,  " _
                        & " Rek_Kelompok,  " _
                        & " Rek_Jenis  "
    ...
    Private Sub view_cPar_RekAPBD_3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
