...
Public Class cgaji_Par_Tunj_fung

    Private Sub tbl_Keluar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbl_Keluar.Click
        Me.Close()
    End Sub

    Private Sub cgaji_Par_Tunj_fung_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        tampil_tabel()
    End Sub
    Sub tampil_tabel()
        ...
        End If
        If mKode_JaFung.Text.Trim <> "" Then
            sql_kondisi_rek = sql_kondisi_rek & "and Kode_JaFung = '" & mKode_JaFung.Text.Trim & "' "
        End If
        ...
        If mcari.Text.Trim = "" Then
            ...
            End If
        Else
            sql_Kondisi = " where (JaFung like '%" & mcari.Text.Trim & "%' ) " & sql_kondisi_rek.Trim
        End If

        Dim sql_Text_Comman As String = "SELECT " _
                                        & " Tahun AS [Tahun], " _
                                        & " Kode_Kel_JaFung + '.' +  " _
                                        & " Kode_JaFung AS [Kode Jab. Fung], " _
                                        & " JaFung AS [Jabatan Fung], " _
                                        & " Tunjangan_Fung AS [Tunjangan Fungsional]," _
                                        & " Kode_Kel_JaFung,Kode_JaFung " _
                                        & " FROM cgaji_Par_Tunj_fung " & sql_Kondisi _
                                        & " ORDER By Kode_Kel_JaFung, Kode_JaFung, Tahun"
    ...
    Private Sub dg_TampilData_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dg_TampilData.CellDoubleClick
        ...
        mKode_JaFung.Text = dg_TampilData.Item(5, dg_TampilData.CurrentRow.Index).Value
        mJaFung.Text = dg_TampilData.Item(2, dg_TampilData.CurrentRow.Index).Value
        mTunjangan_Fung.Text = Format(dg_TampilData.Item(3, dg_TampilData.CurrentRow.Index).Value, "###,###.00")
        ...
        If Rs_Baca.RecordCount > 0 Then
            mKel_JaFung.Text = Rs_Baca.Fields("Kel_JaFung").Value.ToString.Trim
        End If
        Rs_Baca.Close()
        Close_eSumsel()
    End Sub
    Private Sub tbCari01_Click(sender As Object, e As EventArgs) Handles tbCari01.Click
        view_bgaji_Par_JaFung_Kel.mKodePanggil.Text = "cgaji_Par_Tunj_fung"
    ...
    Private Sub tblSimpan_Click(sender As Object, e As EventArgs) Handles tblSimpan.Click
        If mKode_Kel_JaFung.Text.Trim = "" Then
            MsgBox("Kode Kelompok tidak boleh kosong.....", MsgBoxStyle.OkOnly + MsgBoxStyle.Critical, "Informasi")
            Exit Sub
        End If

        If mKode_JaFung.Text.Trim = "" Then
            MsgBox("Kode Jabatan tidak boleh kosong.....", MsgBoxStyle.OkOnly + MsgBoxStyle.Critical, "Informasi")
            Exit Sub
        End If

        If mJaFung.Text.Trim = "" Then
            MsgBox("Nama Jabatan tidak boleh kosong.....", MsgBoxStyle.OkOnly + MsgBoxStyle.Critical, "Informasi")
            Exit Sub
        End If

        If Val(mTunjangan_Fung.Text) <= 0 Then
        ...
        If Open_eSumsel() = False Then Exit Sub
        Dim Cari As String = "T"
        Rs_Simpan.Open("Select Tahun from cgaji_Par_Tunj_fung where " _
                       & " Tahun='" & mTahun.Text & "' and " _
                       & " Kode_Kel_JaFung = '" & mKode_Kel_JaFung.Text & "' and " _
                       & " Kode_JaFung = '" & mKode_JaFung.Text & "'", cn_eSumsel)
        ...
        Dim DeKlare_Data As String = " set dateformat DMY " _
                       ...
                       & " Declare @Kode_JaFung Char(3)" _
                       & " Declare @JaFung  Char(75)" _
                       & " Declare @Tunjangan_Fung   money" _
                       ...
                       & " " _
                        ...
                        & " Set @Kode_JaFung= '" & mKode_JaFung.Text & "' " _
                        & " Set @JaFung= '" & mJaFung.Text & "' " _
                        & " Set @Tunjangan_Fung = '" & mTunjangan_Fung.Text & "' " _
        ...
        Dim Insert_Data As String = " " _
                   & "INSERT INTO cgaji_Par_Tunj_fung" _
                   & "(Tahun,Kode_Kel_JaFung,Kode_JaFung,JaFung,Tunjangan_Fung,UserID_Entry,komputer,MAC0,MAC1,IPAdress,MBId,ProcId,Tanggal,Kode_Dokumen) values " _
                   & "(@Tahun,@Kode_Kel_JaFung,@Kode_JaFung,@JaFung,@Tunjangan_Fung,@UserID_Entry,@komputer,@MAC0,@MAC1,@IPAdress,@MBId,@ProcId,@Tanggal,@Kode_Dokumen)"

        Dim Update_Data As String = " " _
            & " Update cgaji_Par_Tunj_fung Set" _
            & " Tahun = @Tahun, " _
            & " Kode_Kel_JaFung= @Kode_Kel_JaFung, " _
            & " Kode_JaFung= @Kode_JaFung, " _
            & " JaFung= @JaFung, " _
            & " Tunjangan_Fung= @Tunjangan_Fung, " _
            ...
            & " " _
            & " Where Tahun = @Tahun and Kode_Kel_JaFung= @Kode_Kel_JaFung and Kode_JaFung=@Kode_JaFung "
    ...
    Private Sub mKode_JaFung_LostFocus(sender As Object, e As EventArgs) Handles mKode_JaFung.LostFocus
        If Open_eSumsel() = False Then Exit Sub
        Dim Cari As String = "T"
        Rs_Baca.Open("Select * from cgaji_Par_Tunj_fung where " _
                     & " Tahun='" & mTahun.Text & "' and " _
                     & " Kode_Kel_JaFung = '" & mKode_Kel_JaFung.Text & "' and " _
                     & " Kode_JaFung = '" & mKode_JaFung.Text & "'", cn_eSumsel)
        mJaFung.Text = ""
        mTunjangan_Fung.Text = ""
        If Rs_Baca.RecordCount > 0 Then
            mJaFung.Text = Rs_Baca.Fields("JaFung").Value.ToString.Trim
            mTunjangan_Fung.Text = Format(Rs_Baca.Fields("Tunjangan_Fung").Value, "###,###.00")
        End If
        Rs_Baca.Close()
        Close_eSumsel()
    End Sub
    ...
    Private Sub tblHapus_Click(sender As Object, e As EventArgs) Handles tblHapus.Click
        Dim Pesan = MsgBox("Yakin Data Tahun: " & mTahun.Text.Trim & " , Kode Kelompok : " & mKode_Kel_JaFung.Text.Trim & " , Kode Jabatan : " & mKode_JaFung.Text & " ini akan di Hapus [Y/T] ?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "Informasi")
        If Pesan = MsgBoxResult.Yes Then
            If Open_eSumsel() = False Then Exit Sub
            Rs_Simpan.Open("Delete from cgaji_Par_Tunj_fung where Tahun='" & mTahun.Text & "' and Kode_Kel_JaFung = '" & mKode_Kel_JaFung.Text & "' and Kode_JaFung = '" & mKode_JaFung.Text & "'", cn_eSumsel)
    ...
    Private Sub mTunjangan_Fung_GotFocus(sender As Object, e As EventArgs) Handles mTunjangan_Fung.GotFocus
        mTunjangan_Fung.Text = Format(ValChip(mTunjangan_Fung.Text), "######.##")
    End Sub

    Private Sub mTunjangan_Fung_LostFocus(sender As Object, e As EventArgs) Handles mTunjangan_Fung.LostFocus
        mTunjangan_Fung.Text = Format(ValChip(mTunjangan_Fung.Text), "###,###.00")
    End Sub
