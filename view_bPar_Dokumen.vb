...
Public Class view_bPar_Dokumen
    Private Sub tbl_Keluar_Click(sender As Object, e As EventArgs) Handles tbl_Keluar.Click
        Me.Close()
    End Sub

    Private Sub view_bPar_Dokumen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
    ...
    Sub Tampil_Data()
        ...
        Else
            sql_Kondisi = " where Kode_Dokumen like '%" & mCari.Text.Trim & "%' or Nama_Dokumen like '%" & mCari.Text.Trim & "%' "
        End If

        Dim sql_Perintah As String = " SELECT      " _
                    & "   " _
                    & " Kode_Dokumen AS Kode,  " _
                    & " Nama_Dokumen AS [Nama Dokumen] " _
                    & " FROM         bPar_Dokumen " & sql_Kondisi _
                    & " ORDER BY Kode_Dokumen "
