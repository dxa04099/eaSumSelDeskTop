...
Public Class view_cPar_ProgKeg_Program
    ...
    Sub Tampil_Data()
        ...
        If mCari.Text.Trim = "" Then
            ...
            End If
        Else
            sql_Kondisi = " where Nama_Program like '%" & mCari.Text.Trim & "%' " & sql_kondisi_rek.Trim
        End If

        Dim sql_Perintah As String = " SELECT       " _
                    & " Kd_Urusan_Program & '.' &   " _
                    & " Kd_Bidang_Program & '.' &   " _
                    & " Kd_Prog  as [Kode Program], " _
                    & " Nama_Program as [Nama Program], " _
                    & " Kd_Urusan_Program,  " _
                    & " Kd_Bidang_Program,  " _
                    & " Kd_Prog   " _
                    & " FROM cPar_ProgKeg_Program " & sql_Kondisi _
                    & " order by  " _
                    & " Kd_Urusan_Program,  " _
                    & " Kd_Bidang_Program,  " _
                    & " Kd_Prog  "
    ...
    Private Sub view_cPar_ProgKeg_Program_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
