...
Public Class view_cPar_OPD_4Sub_OPD
    ...
    Sub Tampil_Data()
        ...
        If mCari.Text.Trim = "" Then
            ...
            End If
        Else
            sql_Kondisi = " where (Nama_Sub_OPD like '%" & mCari.Text.Trim & "%' ) " & sql_kondisi_rek.Trim
        End If
        ...
        Dim sql_Perintah As String = " SELECT       " _
                    ...
                    & " Kode_Bidang & '.' &   " _
                    & " Kode_OPD & '.' &  " _
                    & " Kode_Sub_OPD  as [Kode],  " _
                    & " Nama_Sub_OPD as [Nama Sub-Sub OPD], " _
                    & " Kode_Urusan,  " _
                    & " Kode_Bidang,  " _
                    & " Kode_OPD,  " _
                    & " Kode_Sub_OPD " _
                    & " FROM          " _
                    & " cPar_OPD_4Sub_OPD " & sql_Kondisi _
                    & " ORDER BY  " _
                    & " Kode_Urusan,  " _
                    & " Kode_Bidang,  " _
                    & " Kode_OPD,  " _
    ...
    Private Sub view_cPar_OPD_4Sub_OPD_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
