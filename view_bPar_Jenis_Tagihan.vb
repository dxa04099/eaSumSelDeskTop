...
Public Class view_bPar_Jenis_Tagihan
    Private Sub tbl_Keluar_Click(sender As Object, e As EventArgs) Handles tbl_Keluar.Click
        Me.Close()
    End Sub

    Private Sub view_bPar_Jenis_Tagihan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
    ...
    Sub Tampil_Data()
        ...
        Else
            sql_Kondisi = " where Kode_Jns_Tagihan like '%" & mCari.Text.Trim & "%' or Nama_Tagihan like '%" & mCari.Text.Trim & "%' "
        End If

        Dim sql_Perintah As String = " SELECT       " _
                & " Kode_Jns_Tagihan AS Kode,  " _
                & " Nama_Tagihan AS [Jenis Tagihan] " _
                & " FROM         bPar_Jenis_Tagihan " & sql_Kondisi _
                & " ORDER BY Kode_Jns_Tagihan "
