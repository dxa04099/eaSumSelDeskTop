...
Public Class view_bPar_Perubahan
    Private Sub tbl_Keluar_Click(sender As Object, e As EventArgs) Handles tbl_Keluar.Click
        Me.Close()
    End Sub

    Private Sub view_bPar_Perubahan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 10
    ...
    Sub Tampil_Data()
        ...
        Dim sql_Perintah As String = " SELECT       " _
                    & " Kode_Perubahan AS Kode,  " _
                    & " Uraian_Perubahan AS [Uraian Perubahan] " _
                    & " FROM         bPar_Perubahan " _
                    & " ORDER BY Kode_Perubahan "
